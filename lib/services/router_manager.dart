...
class SfRouterManager extends NavigatorObserver{
  void showPhotoViewer({required List<ImageProvider> images,int? index,String? heroPrefix,PageController? controller,bool? canSave,SfLoadStateChanged? loadStateChanged,List<Widget> Function(SfPhotoGalleryViewerVM model)? childrenBuilder}) => navigator?.pushNamed(SfRouteName.photo_viewer,arguments:{
  ...
  void showPhotoViewer2({required List<String> imageKeys,int? index,String? heroPrefix,PageController? controller,bool? canSave,String Function(String)? thumbnailGetter,List<Widget> Function(SfPhotoGalleryViewerVM model)? childrenBuilder}) => showPhotoViewer(
